    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              // Script-src: 'unsafe-inline' kept for Next.js hydration scripts.
              // In production, consider nonce-based CSP via middleware for stricter control.
              `script-src 'self'${isDev ? " 'unsafe-eval'" : ""} 'unsafe-inline' https://api.mapbox.com https://js.stripe.com https://js.polar.sh`,
