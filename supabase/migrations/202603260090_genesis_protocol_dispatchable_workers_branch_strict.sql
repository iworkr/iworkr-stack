-- ============================================================================
-- @migration GenesisProtocolDispatchableWorkersBranchStrict
-- @description Tighten branch filter semantics for route optimizer technician selector.
--              When a branch is selected, only workers assigned to that branch are returned.
-- ============================================================================
