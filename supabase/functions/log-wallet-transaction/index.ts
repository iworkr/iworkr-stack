/**
 * @module log-wallet-transaction
 * @status COMPLETE
 * @auth SECURED — Authorization header + auth.getUser() verified
 * @description Logs a petty cash / wallet transaction via RPC with receipt and incident linking
 * @dependencies Supabase (RPC: log_wallet_transaction)
