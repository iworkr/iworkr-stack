...
export default function PaymentFailedEmail({
  ...
  return (
    <EmailLayout preview={`Action required: Payment of ${amount} failed for ${companyName}`}>
      {/* Error accent */}
      <table cellPadding="0" cellSpacing="0" role="presentation" style={{ width: "100%", marginBottom: "28px" }}>
        <tr>
          <td style={{ height: "2px", background: `linear-gradient(90deg, transparent, ${colors.error}, transparent)` }} />
        </tr>
      </table>
      ...
      <Text style={styles.paragraph}>
        ...
        blocks the charge. Please update your payment method to keep your subscription active.
      </Text>
      ...
      <Text style={styles.smallText}>
        If you believe this is a mistake or need assistance, reply to this email and 
