/**
 * @page app/dashboard/assets/loading.tsx
 * @status STABLE
 * @description Loading UI — app/dashboard/assets
      ...
      <div className="border-b border-white/[0.04] bg-zinc-950/80">
        <div className="flex items-center justify-between px-5 py-2.5">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
              ...
              <div className="h-3 w-1 rounded skeleton-shimmer" />
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-7 w-14 rounded-lg skeleton-shimmer" />
        ...
        <div className="flex gap-1 px-5 pb-1.5">
          {["w-24", "w-20", "w-14"].map((w, i) => (
            <div
              key={i}
              className={`h-7 ${w} rounded-md skeleton-shimmer`}
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          ...
          >
            ...
            <div className="space-y-2 px-4 py-3">
              ...
              <div className="mt-1 h-[3px] w-full rounded-full skeleton-shimmer" />
            </div>
          </div>
        ))}
      </div>
