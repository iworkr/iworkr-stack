/**
 * @error app/dashboard/settings/integrations/error.tsx
 * @status STABLE
 * @description Error boundary — app/dashboard/settings/integrations
...
/**
 * Integrations (Ledger-Bridge) Error Boundary
 *
 * Catches crashes from the Xero/MYOB integration page — the most
 * crash-prone settings sub-page due to third-party API dependencies.
 * When this boundary fires, the dashboard shell and settings parent
...
export default function IntegrationsError({
  ...
  useEffect(() => {
    console.error("[Integrations Error Boundary]", {
    ...
    if (
      ...
      Sentry.captureException(error, {
        tags: { module: "integrations", digest: error.digest },
      });
    }
  }, [error]);
    ...
    <div className="flex h-full items-center justify-center p-8">
      ...
      >
        ...
        <h2 className="text-lg font-semibold tracking-tight text-zinc-100">
          Integrations temporarily unavailable
        </h2>
        <p className="mt-2 text-[13px] text-zinc-500">
          The integration service returned an unexpected response. Your
