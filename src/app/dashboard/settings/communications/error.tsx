...
/**
 * Communications (Hermes-Matrix) Error Boundary
 *
 * Catches crashes from the SMS/Email/Push dispatch settings page.
 * Isolates the failure so the rest of the dashboard remains functional.
 */
export default function CommunicationsError({
  ...
  useEffect(() => {
    console.error("[Communications Error Boundary]", {
    ...
    if (
      ...
      Sentry.captureException(error, {
        tags: { module: "communications", digest: error.digest },
      });
    }
  }, [error]);
    ...
    <div className="flex h-full items-center justify-center p-8">
      ...
      >
        ...
        <h2 className="text-lg font-semibold tracking-tight text-zinc-100">
          Communications settings unavailable
        </h2>
        <p className="mt-2 text-[13px] text-zinc-500">
          The notification dispatch settings failed to load. Your existing
          routing rules are still active.
        </p>
