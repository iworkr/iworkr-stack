...
export async function getStaffProfile(
  ...
  try {
    ...
    console.error("[staff-profiles] getStaffProfile failed:", e);
    return null;
  }
}
...
export async function upsertStaffProfile(data: {
  ...
  try {
    ...
    console.error("[staff-profiles] upsertStaffProfile failed:", e);
...
export async function getSchadsRates(
  ...
  try {
    ...
    console.error("[staff-profiles] getSchadsRates failed:", e);
    return [];
  }
}
...
export async function getSchadsRateForLevel(
  ...
  try {
    ...
    console.error("[staff-profiles] getSchadsRateForLevel failed:", e);
    return null;
  }
}
...
export async function getStaffAvailability(
  ...
  try {
    ...
    console.error("[staff-profiles] getStaffAvailability failed:", e);
    return { availability: {}, scheduled_hours: 0, max_hours: 38, blocks: [] };
  }
}
...
export async function getEligibleWorkers(filters: {
  ...
  try {
    ...
    console.error("[staff-profiles] getEligibleWorkers failed:", e);
    return [];
  }
}
...
export async function getOrgStaffProfiles(orgId: string): Promise<StaffProfileWithMeta[]> {
  try {
    ...
    console.error("[staff-profiles] getOrgStaffProfiles failed:", e);
    return [];
  }
}
