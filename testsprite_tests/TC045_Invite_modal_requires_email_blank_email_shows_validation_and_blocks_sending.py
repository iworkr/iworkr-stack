...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign in' link (index 98) to open the login page (/auth).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/header/nav/div[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Type the login email into the email field (index 2048) and proceed to fill password and click Sign In.
        frame = context.pages[-1]
        # Input text
