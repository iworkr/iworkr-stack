...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign in' link (index 117) to open the authentication (/auth) page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/header/nav/div[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Type the test credentials into the email (index 2051) and password (index 2046) fields, then click the Sign In button (index 2053).
        frame = context.pages[-1]
        # Input text
        ...
        assert await frame.locator("xpath=//*[contains(., 'E2E Job - Shortcut')]").nth(0).is_visible(), "Expected 'E2E Job - Shortcut' to be visible"
