...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign in with Password' button (element index 2025) to reveal the email and password input fields.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[3]/div[6]/div/div[2]/button[2]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Type the test email into the email input field (index 2094) as the immediate action.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Sign In' button to submit the login form (index 2096)
        frame = context.pages[-1]
        # Click element
