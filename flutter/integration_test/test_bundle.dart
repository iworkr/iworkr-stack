...
import 'convoy_checkout_gate_test.dart' as convoy_checkout_gate_test;
import 'fort_knox_offline_test.dart' as fort_knox_offline_test;
import 'tests/auth_test.dart' as tests__auth_test;
import 'tests/critical_ops_test.dart' as tests__critical_ops_test;
import 'tests/day_in_life_test.dart' as tests__day_in_life_test;
import 'tests/navigation_test.dart' as tests__navigation_test;
import 'tests/panopticon_test.dart' as tests__panopticon_test;
...
// START: GENERATED TEST GROUPS
  ...
  group('tests.auth_test', tests__auth_test.main);
  group('tests.critical_ops_test', tests__critical_ops_test.main);
  group('tests.day_in_life_test', tests__day_in_life_test.main);
  group('tests.navigation_test', tests__navigation_test.main);
  group('tests.panopticon_test', tests__panopticon_test.main);
